...
Copyright (C) 2015-2017 Alexander Gorishnyak
...
private:
    ...
    /**
      ...
      */
    static bool compressFile(QuaZip* zip, QString fileName, QString fileDest, const int LEVEL = Z_DEFAULT_COMPRESSION);
    ...
    /**
      ...
      \return true if success, false otherwise.
      */
    static bool compressSubDir(QuaZip* parentZip, QString dir, QString parentDir, const int level = Z_DEFAULT_COMPRESSION, bool recursive = true);
...
public:
    ...
    /**
      ...
      \return true if success, false otherwise.
      */
    static bool compressDir(QString fileCompressed, QString dir = QString(), int level = Z_DEFAULT_COMPRESSION, bool recursive = true);
