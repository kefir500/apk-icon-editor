...
ditto -c -k --sequesterRsrc --keepParent "setup/macosx/build/APK Icon Editor.app" "setup/macosx/build/apk-icon-editor_2.1.0.app.zip"
appdmg setup/macosx/appdmg.json "setup/macosx/build/apk-icon-editor_2.1.0.dmg" || { echo "Could not create installer."; exit 4; }
